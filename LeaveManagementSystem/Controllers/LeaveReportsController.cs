    ...
    public class LeaveReportsController : Controller
    {
        ...
        public IActionResult GetLeaveReport(int? employeeId, string status, DateTime? fromDate, DateTime? toDate)
        {
            ...
            try
            {
                ...
                var leaves = _leaveRepository.SearchLeaves(string.IsNullOrEmpty(employeeName)? null: new List<string> { employeeName },statuses,fromDate,toDate,"Admin",employeeId);
